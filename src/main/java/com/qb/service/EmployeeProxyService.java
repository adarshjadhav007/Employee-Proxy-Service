...
public class EmployeeProxyService {
	...
	public ResponseEntity<Integer> getEmployeeByPinCode(Map<String, String> data) {
	...
	public ResponseEntity<List<Employee>> getEmployeeByAgeGroup(Map<String, String> data) {
		RestTemplate restTemplate =new RestTemplate();
